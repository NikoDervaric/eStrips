...
namespace eStrips
{
    public partial class FDR : Form
    {
        ...
        public static Flight flight = eStrips.validFlights.Find(f => f.Callsign == FlightHandler.callsign);
        ...
        private void FDR_Load(object sender, EventArgs e)
        {
            ...
            LblCallsign.Text = FlightHandler.callsign;
            ...
            if (eStrips.exclusionCallsign.Contains(FlightHandler.callsign))
